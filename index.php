...
<body>
    <header id="menu_nav">
        <div class="logomenu"><a href="index.php"> <img class="img-fluid" alt="Logo_img" src="assets/image/testelogo.png"></a></div>
        <nav>
            <ul>
                <a href="index.php">
...
<!----------------------------      Area do Carrinho       -----------------------------  -->
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
           <img src="assets/image/carrinho.gif"> <h5 class="offcanvas-title" id="offcanvasRightLabel">Carrinho</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="cpf" maxlength="14" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
